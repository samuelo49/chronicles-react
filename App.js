    ...
    return (
        <div className="header">
            <div className="logo-container">
                <img
                 className="logo"
                 src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQdaMYtVi9_tfNcpsbGGseU6ehYgV9UeU3h7A&size=256x256" alt="logo" 
                />
            </div>
    ...
    return (
        <div className="res-card" style={{ backgroundColor: "#f0f0f0" }}>
            <img
                ...
                onError={(e) => {
                    e.target.src = "https://picsum.photos/200/150"; // Fallback image
                  }}
